...
public enum StatusCode {
    ...
    PARCEL_IN_THE_CITY1("4", "Відправлення у місті ХХXХ. (Статус для межобластных отправлений)", ORANGE),
    PARCEL_IN_THE_CITY2("41" ,"Відправлення у місті ХХXХ. (Статус для услуг локал стандарт и локал экспресс - доставка в пределах города)", ORANGE),
    PARCEL_ON_ITS_WAY_TO_THE_CITY("5", "Відправлення прямує до міста YYYY", BLUE),
    PARCEL_IN_THE_CITY3("6", "Відправлення у місті YYYY, орієнтовна доставка до ВІДДІЛЕННЯ-XXX dd-mm. Очікуйте додаткове повідомлення про прибуття", ORANGE),
